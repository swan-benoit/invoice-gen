...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'bbca9aa2-ea4d-4e87-a667-c2010ad9b28f' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('232ee187-6bce-46bb-a299-c0744e4aa0bf');
      cy.get(`[data-cy="name"]`).should('have.value', '232ee187-6bce-46bb-a299-c0744e4aa0bf');
